...
DEFAULT_BAD_WORDS = frozenset(["sentence_start", "sentence_end", "br", "lg", "ls", "ns", "sp", "cg", "sl"])
# DEFAULT_BAD_WORDS = frozenset(["br", "lg", "ls", "ns", "sp"])
...
def make_word_ds(grids, trfiles, bad_words=DEFAULT_BAD_WORDS):
    ...
    for st in stories:
        ...
        # goodtranscript = [(start_time, end_time, word)]
